...
exports.registerUser = async (req, res) => {
    try {
        const { name, username, collegeemail, backupemail, password } = req.body;
...
exports.loginUser = async (req, res) => {
    try {
        ...
        // Success response (you might want to add JWT here)
...
exports.resetPassword = async (req, res) => {
    try {
        const { collegeemail, passcode, newPassword } = req.body;
